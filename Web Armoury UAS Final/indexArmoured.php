...
<head>
    ...
    <title>Tanks and Armoured Vehicle</title>
    <!-------------------- Fonst Awesome CDN -------------------->
    ...
    <div class="small-container cart-page">
        <table class="rtable">
            ...
            <?php
                ...
                $data = $showCRUD->armoured_highest_value();
                $list = $data->fetch_assoc();
                $maxSpeed = $list['fastest'];

                $data = $showCRUD->armoured_front_armour();
                $list = $data->fetch_assoc();
                $fontArmour = $list['front'];

                $data = $showCRUD->armoured_side_armour();
                $list = $data->fetch_assoc();
                $sideArmour = $list['side'];

                $data = $showCRUD->armoured_rear_armour();
                $list = $data->fetch_assoc();
                $rearArmour = $list['rear'];

                $data = $showCRUD->armoured_top_armour();
                $list = $data->fetch_assoc();
                $topArmour = $list['topArmour'];

                $data = $showCRUD->armoured_max_ammo();
                $list = $data->fetch_assoc();
                $maxAmmo = $list['ammo'];

                $data = $showCRUD->armoured_max_stabiliser();
                $list = $data->fetch_assoc();
                $maxStabiliser = $list['stabiliser'];

                $data = $showCRUD->armoured_max_AP();
                $list = $data->fetch_assoc();
                $maxAP = $list['AP'];

                $data = $showCRUD->armoured_max_HE();
                $list = $data->fetch_assoc();
                $maxHE = $list['HE'];

                $data = $showCRUD->armoured_max_range();
                $list = $data->fetch_assoc();
                $maxRange = $list['firingRange'];

                $data = $showCRUD->armoured_max_rate();
                $list = $data->fetch_assoc();
                ...
                <tr>
                    ...
                    ?>">x<?php print $list['vehicle_ammo']; ?></td>
                    ...
                    ?>"><?php print $list['vehicle_range']; ?></td>
