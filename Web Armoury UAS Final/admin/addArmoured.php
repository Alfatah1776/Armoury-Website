<h2>Add New Armoured Vehicle</h2>
...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" value="Tank" class="form-control" name="category" readonly>
    </div>
    <div class="form-group">
        <label>Picture</label>
...
if(isset($_POST['save']))
{
    ...
    $saveCRUD = new CRUD();
    $newList = $saveCRUD->create_armoured_data($vehicleName, $vehicleOrigin, $vehicleCategory, $vehiclePicture, $vehicleWeapon, 
