<h2>Edit Support Vehicle Data</h2>
<?php
if(isset($_GET['id']))
    $editCRUD = new CRUD();
    $data = $editCRUD->edit_support_data($_GET['id']);
...
if(isset($_POST['update']))
{
    ...
    $uploadArmouredCRUD = $updateArmouredCRUD->update_support_data($vehicleID, $vehicleName, $vehicleOrigin, 
